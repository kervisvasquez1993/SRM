...
class ProductosImport implements ToCollection/* , WithStartRow,WithCalculatedFormulas */
{
    ...
    public function collection(Collection $rows)
    {
        ...
        foreach ($rows as $row) 
        {
            $product = [
             ...
             $producto =  Producto::where('product_name_supplier', $product['product_name_supplier'])->get();
