...
@section('content')
    ...
    <h4>Crear una incidencia sobre Transito Nacionalización</h4>

    <form method="POST" action="{{ route('transito-nacionalizacion.store', ['id_produccion_transito' => $idProduccionTransito]) }}">
        @csrf
