...
@section('content')
    ...
    <form novalidate class="m-2" method="POST" action="{{ route('pago-balance.store', ['id_produccion_transito' => $idProduccionTransito]) }}">
        ...
        <div class="row">
            ...
            <div class="form-check">
                <label class="form-check-label">
                    <input class="form-check-input" type="checkbox" name="pago_completo" value="{{ true }}">
                    ¿Es el pago completo?
