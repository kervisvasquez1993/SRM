...
import { emptyIncident } from "../ProductionStart/ProductionStartIncidentModal";

import ProductionEndCard from "./ProductionEndCard";
import ProductionEndModal from "./ProductionEndModal";

const ProductionEndTab = ({ production }) => {
    ...
    useEffect(() => {
        dispatch(getProductionIncidents("fin_produccion", production.id));
    }, []);
...
export default ProductionEndTab;
